...
static const int LAST_POW_BLOCK = 52560000; //about 10,000 Years of PoW blocks
...
static const int64_t MAX_MONEY = 5500000000 * COIN;
static const int64_t MAX_MINT_PROOF_OF_STAKE = 3 * CENT; // 5% per year
...
static const uint256 hashGenesisBlock("0x000006a48995a1e017ee6dbc985599b29739c14bd59e1aec3d583782d79d836c");
static const uint256 hashGenesisBlockTestNet("0x000006a48995a1e017ee6dbc985599b29739c14bd59e1aec3d583782d79d836c");
...
public:
    ...
    {
        // IBTCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // IBTCoin: get transaction coin age
...
public:
    ...
    // IBTCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // IBTCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // IBTCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // IBTCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // IBTCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // IBTCoin: block index flags
    enum  
    {
